...
function _artist(FileAttachment) {
  return FileAttachment("./artist.csv").csv();
}
...
function _data(
  ...
  // 將內外圈答案結合，形成新的答案陣列
  var combinedAnswers = innerCircleAnswer.map(
    (innerAns, index) => innerAns + "-" + outerCircleAnswer[index]
  );
...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>相對於文藝相關工作者，特別是工作室佔問卷的多數填寫者</li>
    <li>其中最常見者為節約能源、使用再生材料、減少包裝</li>
  </ul>
</h3>
  `;
}
...
function _19(htl) {
  return htl.html`<!-- 參考 https://observablehq.com/d/c84affd948a1e733 -->
<style>
.tooltip {
  padding: 8px 12px;
  color: white;
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    [
      ...
      {
        url: new URL(
          "./files/50c5f49fe0be94803e1d055aaca895517461971b40fc91cc553044dee88321c73843858f823684904e961847c7cc5d3bb60f8ecd7cdfde293dd65a61d08e1e2d.csv",
          import.meta.url
        ),
        mimeType: "text/csv",
        toString,
